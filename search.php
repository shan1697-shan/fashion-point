...
<html>
<head>
	<title>Search: Fashion Point</title>
</head>
<body>
	<div class="container my-4">
		<h3>Search Results For <?php echo $search;?></h3><br>
		<div class="row" style="text-align: center; margin-left: 50px;">

		<?php
		$var = 0;
		while($row = mysqli_fetch_assoc($query)) {
			if(strpos($row["name"], $search) !== false OR strpos($row["category"], $search) !== false OR strpos($row["description"], $search) !== false){
			   ?>
